...
import { createSalesRecord, updateSalesRecord } from "../services/SaleService";

// TODO: Validation Schema

const SalesRecordForm = ({ open, handleClose, onRecordAdded, onRecordEdited, editRecord }) => {
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            console.error(`Failed to ${editMode ? "update" : "create"} sales record: `, error);
        } finally {
            setSubmitting(false);
        }
    }
    ...
    return (
        ...
        >
                <DialogTitle textAlign="center" variant="h3" margin="10px 0">
                    {editMode ? "Edit Sales Record" : "Add New Sales Record"}</DialogTitle>
                <DialogContent>
                    <Formik
